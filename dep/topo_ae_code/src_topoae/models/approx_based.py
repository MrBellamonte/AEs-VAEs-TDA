...
from dep.topo_ae_code.src_topoae.topology import PersistentHomologyCalculation #AlephPersistenHomologyCalculation, \
from dep.topo_ae_code.src_topoae.models import submodules
...
class TopologicallyRegularizedAutoencoder(AutoencoderModel):
    ...
    def __init__(self,autoencoder, lam=1.,
