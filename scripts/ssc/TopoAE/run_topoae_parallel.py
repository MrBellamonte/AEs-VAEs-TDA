from scripts.ssc.TopoAE.config_libraries.swissroll import \
    (
    swissroll_midsize_lowbs_local_seed1_parallel_shuffled, swissroll_asymmetric)
...
if __name__ == "__main__":
    ...
    Parallel(n_jobs=4)(delayed(simulator_TopoAE)(config) for config in swissroll_asymmetric)
