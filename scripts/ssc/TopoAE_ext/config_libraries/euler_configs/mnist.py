...
mnist_s838_512_s1 = ConfigGrid_WCAE(
    learning_rate=[1/100],
    batch_size=[512],
    n_epochs=[1000],
    weight_decay=[1e-6],
    ...
    uid=[''],
    toposig_kwargs=[dict()],
    method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1], online_wc=[True], wc_offline = [dict(path_to_data = wcpath_mnist_s838_512)]),
...
mnist_s838_1024_s1 = ConfigGrid_WCAE(
    learning_rate=[1/100],
    batch_size=[1024],
    n_epochs=[1000],
    weight_decay=[1e-6],
