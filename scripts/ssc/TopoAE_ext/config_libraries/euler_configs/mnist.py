...
mnist_s838_256_l = ConfigGrid_WCAE(
    learning_rate=[1/100],
    batch_size=[256],
    n_epochs=[1000],
    weight_decay=[1e-6],
    early_stopping=[50],
    rec_loss_weight=[1],
    top_loss_weight=[int(i) for i in np.logspace(13, 14, num=2, base=2.0)],
    match_edges=['push_active'],
    k=[1,2,4],
    r_max=[10],
    model_class=[ConvAE_MNIST],
...
mnist_s838_512_l = ConfigGrid_WCAE(
    learning_rate=[1/100],
    batch_size=[512],
    n_epochs=[1000],
    weight_decay=[1e-6],
...
mnist_s838_1024_l = ConfigGrid_WCAE(
    learning_rate=[1/100],
    batch_size=[1024],
    n_epochs=[1000],
    weight_decay=[1e-6],
