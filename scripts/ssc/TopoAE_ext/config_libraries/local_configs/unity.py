...
xytrans_openai_test = ConfigGrid_WCAE(
        ...
        method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1], online_wc=[True], dist_x_land = [True],val_size = [0],
                         wc_offline=[dict(path_to_data='/Users/simons/PycharmProjects/MT-VAEs-TDA/src/datasets/simulated/xy_trans')]),
        experiment_dir='/Users/simons/PycharmProjects/MT-VAEs-TDA/output/WAE/openai/xy_trans',
        seed=1,
        device='cpu',
        num_threads=1,
        verbose=True,
