...
mnist_1_deep8d = [ConfigGrid_TopoAE(
    ...
    uid=[''],
    method_args=[None],
    experiment_dir='/cluster/scratch/schsimo/output/mnist_topoae_1_deepae8',
    seed=seed,
    device='cpu',
    num_threads=1,
    verbose=False
...
mnist_1_deep8d_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_1_deep8d]))