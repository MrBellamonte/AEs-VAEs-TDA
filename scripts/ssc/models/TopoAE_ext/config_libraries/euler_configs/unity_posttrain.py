...
rotopenai_2_local= ConfigGrid_WCAE(
    ...
    experiment_dir='/output/WAE/openai/retrain_examples/2_',
    seed=1,
    device='cpu',
    num_threads=1,
    verbose=True,
...
rotopenai_g4_cluster= ConfigGrid_WCAE(
    ...
    method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1.0625], online_wc=[True],
                     ...
                     wc_offline=[dict(
                         path_to_data='/cluster/home/schsimo/MT/AEs-VAEs-TDA/src/datasets/simulated/openai_rotating')],
                     pre_trained_model = ['/cluster/scratch/schsimo/output/rotating_retrain/Unity_RotOpenAI-seed1-ConvAE_Unity480320-default-lr1_10000-bs180-nep20000-rlw1-tlw1-mepush_active9_8-k2-rmax10-seed1-a1266ff7']),
    experiment_dir='/cluster/scratch/schsimo/output/rotating_retrain',
    seed=1,
    device='cuda',
    num_threads=1,
...
rotopenai_g45cluster= ConfigGrid_WCAE(
    learning_rate=[5/100000],
    batch_size=[180],
    n_epochs=[20000],
    weight_decay=[1e-6],
    early_stopping=[500],
