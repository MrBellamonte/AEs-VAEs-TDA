...
mnist_1_k12_deepae4 = [ConfigGrid_WCAE(
    ...
    experiment_dir='/cluster/scratch/schsimo/output/mnist_wae_1_deepae4',
    seed=838,
    device='cuda',
    num_threads=2,
...
mnist_1_k12_deepae4_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_1_k12_deepae4]))

mnist_1_k48_deepae4 = [ConfigGrid_WCAE(
    learning_rate=[1/10, 1/100, 1/1000],
    batch_size=[bs],
    n_epochs=[1000],
    weight_decay=[1e-6],
...
mnist_1_k48_deepae4_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_1_k48_deepae4]))


mnist_1_k1216_deepae4 = [ConfigGrid_WCAE(
    learning_rate=[1/10, 1/100, 1/1000],
    batch_size=[bs],
    n_epochs=[1000],
    weight_decay=[1e-6],
...
mnist_1_k1216_deepae4_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_1_k1216_deepae4]))