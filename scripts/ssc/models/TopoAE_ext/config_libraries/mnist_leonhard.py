...
mnist_s838_1024_llw = ConfigGrid_WCAE(
    learning_rate=[1/10,1/100, 1/1000],
    batch_size=[1024],
    n_epochs=[1000],
    weight_decay=[1e-6],
    ...
    method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1, 1.125], online_wc=[True],
                     wc_offline=[dict(path_to_data=wcpath_mnist_s838_1024)]),
    experiment_dir='/cluster/scratch/schsimo/output/mnist1024_3',
    seed=838,
    device='cuda',
    num_threads=2,
    verbose=False,
...
mnist_s838_512_llw = ConfigGrid_WCAE(
    learning_rate=[1/10, 1/100, 1/1000],
    batch_size=[512],
    n_epochs=[1000],
    weight_decay=[1e-6],
    ...
    method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1, 1.125], online_wc=[True],
                     wc_offline=[dict(path_to_data=wcpath_mnist_s838_512)]),
    experiment_dir='/cluster/scratch/schsimo/output/mnist512_3',
    seed=838,
    device='cuda',
    num_threads=2,
    verbose=False,
...
mnist_s838_256_llw = ConfigGrid_WCAE(
    learning_rate=[1/10, 1/100, 1/1000],
    batch_size=[256],
    n_epochs=[1000],
    weight_decay=[1e-6],
    ...
    method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1, 1.125], online_wc=[True],
                     wc_offline=[dict(path_to_data=wcpath_mnist_s838_256)]),
    experiment_dir='/cluster/scratch/schsimo/output/mnist256_3',
    seed=838,
    device='cuda',
    num_threads=2,
    verbose=False)
...
ConfigGrid_WCAE(
    ...
    early_stopping=[30],
    rec_loss_weight=[1],
    top_loss_weight=[i for i in np.logspace(-4, 0, num=5, base=2.0)],
    match_edges=['push_active'],
    k=[8,12,16],
    r_max=[10],
    model_class=[ConvAE_MNIST],
    ...
    experiment_dir='/cluster/scratch/schsimo/output/mnist_4',
    seed=838,
    device='cuda',
    num_threads=2,
...
mnist_4_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_4]))
