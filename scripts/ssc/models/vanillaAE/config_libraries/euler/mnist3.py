...
mnist_1_deepae3 = [ConfigGrid_VanillaAE(
    ...
    uid=[''],
    method_args=[dict()],
    experiment_dir='/cluster/scratch/schsimo/output/mnist_ae_1_deepae3',
    seed=seed,
    device='cpu',
    num_threads=1,
    verbose=False) for seed in [838,579,1988]]

mnist_1_deepae3_list = list(itertools.chain(*[config_grid.configs_from_grid() for config_grid in mnist_1_deepae3]))