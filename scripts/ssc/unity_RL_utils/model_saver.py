...
if __name__ == "__main__":
    ...
    state_dict = torch.load(os.path.join(os.path.join(root_path_rl,exp_rl), 'model_state.pth'),map_location=device)
    ...
    path_to_save = os.path.join(dir_to_save,'m_rl1.onnx')
