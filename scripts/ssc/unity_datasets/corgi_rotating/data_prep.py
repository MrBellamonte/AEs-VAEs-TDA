...
root_path_save ='/Users/simons/PycharmProjects/MT-VAEs-TDA/src/datasets/simulated/corgi_rotation_{}'.format(version)
...
ind_train = ind_all[:60]
ind_eval = ind_all[240:300]
ind_test = ind_all[300:]
