...
if __name__ == "__main__":
    ...
    corgi_1 = ConfigGrid_WCAE(
        ...
        sampling_kwargs=[dict(version = 2)],
        eval=[ConfigEval(
            active=True,
            evaluate_on='test',
            eval_manifold=False,
        ...
        method_args=dict(n_jobs=[1], normalize=[True], mu_push=[1], online_wc=[True], dist_x_land = [True],
                         wc_offline=[dict(path_to_data='/Users/simons/PycharmProjects/MT-VAEs-TDA/src/datasets/simulated/corgi_rotation_2')]),
        experiment_dir='/Users/simons/PycharmProjects/MT-VAEs-TDA/output/WAE/corgi/rotating2',
        seed=1,
        device='cpu',
        num_threads=2,
        verbose=True,
